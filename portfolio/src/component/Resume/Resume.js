              ...
              <div className='content'>
                {ResumeApi.map((val, id) => {
                  if (val.category === "education") {
                    return <Card key={id} title={val.title} year={val.year} company={val.company} location={val.location} desc={val.desc} />
                  }
                })}
              ...
              <div className='content'>
                {ResumeApi.map((val, index) => {
                  if (val.category === "experience") {
                    return <Card key={index} title={val.title} year={val.year} company={val.company} location={val.location}  desc={val.desc} />
                  }
                })}
              </div>
            </div>
